...
export const translations = {
  eng: {
    ...
    loadQuery: {
      ...
      confirmLoadMessage: 'Are you sure you want to load query "{0}"? This will replace your current query.',
      loadButton: 'Load',
      cancelButton: 'Cancel',
      deleteButton: 'Delete',
  ...
  est: {
    ...
    loadQuery: {
      ...
      confirmLoadMessage: 'Kas oled kindel, et soovid laadida päringu "{0}"? See asendab sinu praeguse päringu.',
      loadButton: 'Lae',
